...
var scales = d3.select(".scale-container").append('svg')
    .attr('width', 700)
    .attr('height', d3.select(".scale-container").node().getBoundingClientRect().height);
...
d3.json("../data/combined.json", function(error, arab) {
    d3.json("../../data/battles-geo.json", function(error, battles) {
        ...
        var simulation = d3.forceSimulation(battlesData)
            .force("x", d3.forceX(function(d) { return x(d.properties.date); }).strength(1))
...
function showHideBorders(cb) {
    if (cb.checked) {
        console.log("Checked")
        $(".no-relief.BHR, .no-relief.QAT, .no-relief.KWT, .no-relief.ARE, .no-relief.SAU, .no-relief.SYR, .no-relief.IRQ, .no-relief.IRN, .no-relief.AFG, .no-relief.JOR, .no-relief.OMN, .no-relief.YEM, .no-relief.PSX").css("stroke", "none");
        $(".country.BHR, .country.QAT, .country.KWT, .country.ARE, .country.SAU, .country.SYR, .country.IRQ, .country.IRN, .country.AFG, .country.JOR, .country.OMN, .country.YEM, .country.PSX").css("stroke", "none");
        $(".no-relief, .country").css("stroke: none");
    } else {
        $(".no-relief.BHR, .no-relief.QAT, .no-relief.KWT, .no-relief.ARE, .no-relief.SAU, .no-relief.SYR, .no-relief.IRQ, .no-relief.IRN, .no-relief.AFG, .no-relief.JOR, .no-relief.OMN, .no-relief.YEM, .no-relief.PSX").css("stroke", "#999");
        $(".country.BHR, .country.QAT, .country.KWT, .country.ARE, .country.SAU, .country.SYR, .country.IRQ, .country.IRN, .country.AFG, .country.JOR, .country.OMN, .country.YEM, .country.PSX").css("stroke", "#999");
    }
}
